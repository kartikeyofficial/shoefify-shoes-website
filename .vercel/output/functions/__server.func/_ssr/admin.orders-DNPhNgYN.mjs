...
import { O as ORDER_STATUS_LABELS, f as formatINR } from "./router-VAEstg49.mjs";
import { b as getAdminOrders, u as updateOrderStatus } from "./order.functions-Du0TUgdI.mjs";
