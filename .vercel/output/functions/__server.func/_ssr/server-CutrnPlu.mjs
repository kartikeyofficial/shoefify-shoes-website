...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-CBW-NwYZ.mjs");
...
const manifest = {
  "007e4e915d0f2bb0adeff3f4ba514dea8e2a5b5b4f81f74abf55e7a24731f494": {
    ...
    importer: () => import("./order.functions-BC-XCmb_.mjs")
  },
  ...
  "10cc5b7a83d5f2a0269cb4e80439dc0f8d778b1b9c90e7bb6c91b959fd78c730": {
    ...
    importer: () => import("./product.functions-BYq1E6mg.mjs")
  },
  ...
  "5e2c6a85ce8b9f3a92cd9b0a9b4d8f015d9ec2fa0b30eb31f8605ecef9f67199": {
    ...
    importer: () => import("./razorpay.functions-BNqoBO7n.mjs")
  },
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-VAEstg49.mjs").then((n) => n.r),
    import("./start-DLPR43Bl.mjs"),
