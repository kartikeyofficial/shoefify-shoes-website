...
import { O as ORDER_STATUS_LABELS, f as formatINR } from "./router-CHbF3jR6.mjs";
import { b as getAdminOrders, u as updateOrderStatus } from "./order.functions-DttxRx8H.mjs";
