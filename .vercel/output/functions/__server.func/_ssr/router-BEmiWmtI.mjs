...
import { c as createServerFn, T as TSS_SERVER_FUNCTION, g as getServerFnById } from "./server-DRQnurSj.mjs";
import { c as create, p as persist } from "../_libs/zustand.mjs";
import { L as LayoutGrid, U as User, H as Heart, S as ShoppingBag, X, M as Menu } from "../_libs/lucide-react.mjs";
...
}).parse(input)).handler(createSsrRpc("8885861039572e17b151c0588957f0e59300c2ba8d7e1673c4c710b2a18a91dd"));
const getWishlistItems = createServerFn({
  method: "GET"
}).handler(createSsrRpc("c1af8c3ef795622140f5443fd03b2f7f24a45b72e3fa702eaaa5eb94dc49f8de"));
const getWishlistCount = createServerFn({
  method: "GET"
}).handler(createSsrRpc("a8fa38492d5ee54e688bb1e4061c06f3af62693959d1ae650dbe29455400a108"));
function SiteHeader() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "sticky top-0 z-40 border-b border-border bg-background/85 backdrop-blur", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto flex h-16 max-w-7xl items-center justify-between px-5", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/wishlist", className: "relative rounded-full p-2 hover:bg-secondary", "aria-label": "wishlist", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Heart, { className: "size-5" }),
          wishlistCount > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute -right-0.5 -top-0.5 flex h-4 min-w-4 items-center justify-center rounded-full bg-accent px-1 text-[10px] font-medium text-accent-foreground", children: wishlistCount })
        ] }),
...
const appCss = "/assets/styles-DdpYDzpc.css";
...
const $$splitComponentImporter$k = () => import("./wishlist-D93FQAXI.mjs");
const Route$k = createFileRoute("/wishlist")({
  head: () => ({
    meta: [{
      title: "Your wishlist — Shoefify"
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$k, "component")
});
const $$splitComponentImporter$j = () => import("./signup-60t-c1uC.mjs");
...
const $$splitComponentImporter$i = () => import("./login-CRLsgqwQ.mjs");
...
const $$splitComponentImporter$h = () => import("./help-CGlSz1HZ.mjs");
...
const $$splitComponentImporter$g = () => import("./contact-DRLuDzPS.mjs");
...
const $$splitComponentImporter$f = () => import("./checkout-tOYIyFZY.mjs");
...
const $$splitComponentImporter$e = () => import("./cart-Bkc_1HTU.mjs");
...
const $$splitComponentImporter$d = () => import("./admin-Bb7hRt76.mjs");
...
const $$splitComponentImporter$c = () => import("./account-DWhKu6Xq.mjs");
...
const $$splitComponentImporter$b = () => import("./about-nC_LTK-2.mjs");
...
const $$splitComponentImporter$a = () => import("./index-BQccO-4C.mjs");
...
const $$splitComponentImporter$9 = () => import("./shop.index-DHUun36L.mjs");
...
const $$splitComponentImporter$8 = () => import("./admin.index-hXZ6gLgL.mjs");
const Route$8 = createFileRoute("/admin/")({
  component: lazyRouteComponent($$splitComponentImporter$8, "component")
});
const $$splitComponentImporter$7 = () => import("./shop._category-fvMqrdRv.mjs");
...
const $$splitComponentImporter$6 = () => import("./product._slug-De8f0wM3.mjs");
...
const $$splitComponentImporter$5 = () => import("./order._orderNumber-BHsAuQW0.mjs");
...
const $$splitComponentImporter$4 = () => import("./admin.products-DV6QYqcc.mjs");
const Route$4 = createFileRoute("/admin/products")({
  component: lazyRouteComponent($$splitComponentImporter$4, "component")
});
const $$splitComponentImporter$3 = () => import("./admin.orders-CKfSTvJD.mjs");
const Route$3 = createFileRoute("/admin/orders")({
  component: lazyRouteComponent($$splitComponentImporter$3, "component")
});
const $$splitComponentImporter$2 = () => import("./admin.messages-D_47LR3O.mjs");
const Route$2 = createFileRoute("/admin/messages")({
  component: lazyRouteComponent($$splitComponentImporter$2, "component")
});
const $$splitComponentImporter$1 = () => import("./admin.categories-BfOL_ye2.mjs");
const Route$1 = createFileRoute("/admin/categories")({
  component: lazyRouteComponent($$splitComponentImporter$1, "component")
});
const $$splitComponentImporter = () => import("./account.orders-C4Bb0ebq.mjs");
...
const WishlistRoute = Route$k.update({
  id: "/wishlist",
  path: "/wishlist",
