...
import require$$0$9 from "fs/promises";
...
function requireConstants$1() {
  ...
  constants$1.MAX_SUPPORTED_SERVER_VERSION = "8.2";
  ...
  constants$1.MAX_SUPPORTED_WIRE_VERSION = 27;
